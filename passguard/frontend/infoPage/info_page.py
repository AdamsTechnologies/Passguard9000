...
class InfoFrame(ttk.Frame):
    # TODO currently the frames are all wonky.. update to mirror how settings_page works.
    def __init__(self, master, pg_styles: ttk.Style, *args, **kwargs):
        ...
        self.columnconfigure(0, weight=1, uniform='col')  # 25%
        self.columnconfigure(1, weight=3, uniform='col')  # 75%
